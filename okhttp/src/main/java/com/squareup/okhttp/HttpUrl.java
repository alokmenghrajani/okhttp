...
public final class HttpUrl {
   ...
   * query string like {@code subject=math&easy&problem=2+2=4} into the list {@code ["subject",
   * "math", "easy", null, "problem", "2+2=4"]}. Note that values may be null and may contain
   * '=' characters.
   */
  ...
  public static final class Builder {
    ...
    private void resolvePath(String input, int pos, int limit) {
      // Read a delimiter.
      if (pos == limit) return; // Empty path: keep the base path as-is.
